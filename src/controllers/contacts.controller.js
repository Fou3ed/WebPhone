...
export const getContactsById = (req, res) => {
    ...
    ContactModel.getContactById(req.params.id, req.query.offset, (contacts, error) => {
...
export const getContactsByFavorite = (req, res) => {
    ...
    ContactModel.getContactByFavorite(req.params.id, req.query.offset, (contacts, error) => {
