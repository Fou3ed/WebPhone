...
export const updateUser = async (req, res) => {
    if (!req.body.username || !req.body.default_theme || !req.body.default_language || !req.body.default_timezone || !req.body.default_ring_sound || !req.body.email || !req.body.status) {
        res.status(400).send({
            success: false,
            message: 'wrong parameters',
            code: 'users_information_Invalid'
